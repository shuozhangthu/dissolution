...
ic = @(x) icFunc(x);
bc = @(xl,ul,xr,ur,t,v,vdot) bcFunc(xl,ul,xr,ur,t,v,vdot, D, L);
...
% ax = gca;
% ax.LineWidth = 1.5;
% text(5,0.85,'Naviaux et al. (2019), GCA, Fig.1a,\newline21 ^oC, 70-100 \mum size\newline\Omega=0.83, R_{meas}=2.18\times10^{-9} mol/m^2/s','FontSize',16)
% 
% % % print('fs_time_slow.jpg','-djpeg','-r1200');
% 
% figure;
...
% xlabel('Depth (nm)');
% xlim([0 50])
% ylabel('f_{13} in the bulk solid at t=100 hours');
% box on
% ax = gca;
% ax.LineWidth = 1.5;
% text(10,0.6,'Naviaux et al. (2019), GCA, Fig.1a,\newline21 ^oC, 70-100 \mum size\newline\Omega=0.83, R_{meas}=2.18\times10^{-9} mol/m^2/s','FontSize',16)
% % print('fb_depth_slow.jpg','-djpeg','-r1200');
% 
% figure
...
% ax = gca;
% ax.LineWidth = 1.5;
% text(5,0.7,'Naviaux et al. (2019), GCA, Fig.1a,\newline21 ^oC, 70-100 \mum size\newline\Omega=0.83, R_{meas}=2.18\times10^{-9} mol/m^2/s','FontSize',16)
% % print('percent_dissolved_slow.jpg','-djpeg','-r1200');
% 
% figure
% plot(diff)
% title('diff')
